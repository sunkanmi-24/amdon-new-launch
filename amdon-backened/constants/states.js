/**
 * @typedef {Object} NigerianState
 * @property {string} name - Full state name
 * @property {string} code - 2-letter abbreviation used in AMDON ID
 * @property {string[]} lgas - List of LGAs in the state
 */
 ...
 * Get state by name
 * @param {string} name
 * @returns {NigerianState | undefined}
 */
...
const getStateByCode = (code) =>
  NIGERIAN_STATES.find((s) => s.code.toLowerCase() === code.toLowerCase());

module.exports = { NIGERIAN_STATES, getStateByName, getStateByCode };